...
export default function AIAssistant() {
  ...
  const salesForecast = [
    { date: '2025-11-01', predicted: 1200, actual: 1150 },
    { date: '2025-11-02', predicted: 1350, actual: 1320 },
    { date: '2025-11-03', predicted: 1500, actual: null },
    { date: '2025-11-04', predicted: 1450, actual: null },
    { date: '2025-11-05', predicted: 1600, actual: null },
    { date: '2025-11-06', predicted: 1550, actual: null },
    { date: '2025-11-07', predicted: 1700, actual: null },
  ]

  // Mock data for demand forecasting
  const demandForecast = [
    { product: 'Rice 5kg', current_demand: 45, predicted_demand: 52, trend: 'increasing' },
    { product: 'Milk 1L', current_demand: 30, predicted_demand: 35, trend: 'increasing' },
    { product: 'Bread', current_demand: 25, predicted_demand: 28, trend: 'stable' },
    { product: 'Eggs', current_demand: 40, predicted_demand: 38, trend: 'decreasing' },
  ]

  // Mock customer engagement data
  const customerEngagement = [
    { customer: 'John Doe', last_purchase: '2025-11-01', total_purchases: 15, engagement_score: 85 },
    { customer: 'Jane Smith', last_purchase: '2025-10-28', total_purchases: 8, engagement_score: 65 },
    { customer: 'Bob Johnson', last_purchase: '2025-10-15', total_purchases: 3, engagement_score: 35 },
  ]
  ...
  const handleSendMessage = () => {
    ...
    const responses = [
      "Based on your sales data, I recommend focusing on top-selling products to maximize revenue.",
      "Your inventory levels look good. Consider restocking items that are below the minimum threshold.",
      "Customer engagement has improved this month. Keep up the great work!",
      "I can help you analyze sales trends, predict demand, and provide insights on customer behavior.",
    ]
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Get intelligent insights and assistance for your business</p>
      </div>
      ...
      {activeTab === 'sales' && (
        <Card>
          <CardHeader>
            <CardTitle>Sales Forecasting (Next 7 Days)</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-blue-800">
                Based on historical data, sales are predicted to increase by 15% over the next week. 
                Peak sales are expected on Day 7 with an estimated revenue of ৳1,700.
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <CardContent>
              ...
              <div className="mt-4 p-4 bg-green-50 rounded-lg">
                ...
                <ul className="list-disc list-inside text-green-800 space-y-1">
                  <li>Increase stock for Rice 5kg - high demand expected</li>
                  <li>Monitor Milk 1L inventory - rising trend detected</li>
                  <li>Consider promotions for Eggs - demand declining</li>
                </ul>
              </div>
            </CardContent>
          </Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 p-4 bg-purple-50 rounded-lg">
              ...
              <p className="text-purple-800">
                High-engagement customers (70%+) should receive loyalty rewards. 
                Low-engagement customers may need re-engagement campaigns.
              </p>
            </div>
          </CardContent>
        </Card>
